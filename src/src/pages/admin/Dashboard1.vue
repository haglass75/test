<template>
  <div class="space-y-6 text-black dark:bg-black dark:text-white p-4 rounded">
    <!-- Font Awesome CDN 추가 -->
    <link
      rel="stylesheet"
    ...
    <!-- 통계 카드 -->
    <div class="grid grid-cols-3 max-[900px]:gap-2 gap-3 w-full">
      <div
        class="bg-white dark:bg-gray-800 rounded-lg shadow p-4 md:p-6 hover:shadow-lg transition-shadow">
        <div class="flex items-center w-full">
          <div
            class="icon-box w-[51px] p-3 rounded-full bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-300">
            <i class="fas fa-calendar-check pl-1 text-xl md:text-2xl"></i>
          </div>
          <div class="ml-4">
      ...
      <div
        ...
        <div class="flex items-center">
          <div
            class="icon-box p-3 rounded-full bg-green-100 dark:bg-green-900 text-green-600 dark:text-green-300">
            <i class="user fas fa-users text-xl md:text-2xl"></i>
          </div>
          <div class="ml-4">
            <h3 class="max-[900px]:hidden text-sm font-medium text-gray-500 dark:text-gray-400" >
              전체 사용자 
            </h3>
            <h3 class="hidden max-[900px]:inline text-sm font-medium text-gray-500 dark:text-gray-400" > 사용자들</h3>
            <p
              class="text-xl md:text-2xl font-semibold text-gray-800 dark:text-white">
              50
            </p>
      ...
      <div
        ...
        <div class="flex items-center">
          <div
            class="icon-box p-3 rounded-full bg-yellow-100 dark:bg-yellow-900 text-yellow-600 dark:text-yellow-300">
            <i class="star fas fa-star text-xl md:text-2xl"></i>
          </div>
          <div class="ml-4">
            <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400">
              평균 평점
        ...
        <div
          ...
          <div>
            <p class="text-sm text-gray-700 dark:text-gray-300">
              ...
              >-
              <span class="font-medium">{{
                Math.min(currentPage * itemsPerPage, filteredReservaions.length)
              }}</span
              >개 표시
            </p>
          </div>
